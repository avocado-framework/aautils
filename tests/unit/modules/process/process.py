...
from autils.process import process
from autils.utils import script
...
class TestSubProcess(unittest.TestCase):
    @unittest.mock.patch("autils.process.process.SubProcess._init_subprocess")
    @unittest.mock.patch("autils.process.process.SubProcess.is_sudo_enabled")
    @unittest.mock.patch("autils.process.process.SubProcess.get_pid")
    @unittest.mock.patch("autils.process.process.get_children_pids")
    @unittest.mock.patch("autils.process.process.run")
    ...
    @unittest.mock.patch("autils.process.process.SubProcess._init_subprocess")
    @unittest.mock.patch("autils.process.process.SubProcess.get_pid")
    @unittest.mock.patch("autils.process.process.get_owner_id")
...
class MiscProcessTests(unittest.TestCase):
    ...
    @unittest.mock.patch("autils.process.process.os.kill")
    @unittest.mock.patch("autils.process.process.get_owner_id")
    ...
    @unittest.mock.patch("autils.process.process.os.stat")
    ...
    @unittest.mock.patch("autils.process.process.time.sleep")
    @unittest.mock.patch("autils.process.process.safe_kill")
    @unittest.mock.patch("autils.process.process.get_children_pids")
    ...
    @unittest.mock.patch("autils.process.process.safe_kill")
    @unittest.mock.patch("autils.process.process.get_children_pids")
    @unittest.mock.patch("autils.process.process.time.time")
    @unittest.mock.patch("autils.process.process.time.sleep")
    @unittest.mock.patch("autils.process.process.pid_exists")
    ...
    @unittest.mock.patch("autils.process.process.os.getuid")
    ...
    @unittest.mock.patch("autils.process.process.system")
    @unittest.mock.patch("autils.file.path.find_command")
    @unittest.mock.patch("autils.process.process.os.getuid")
    ...
    @unittest.mock.patch("autils.process.process.get_capabilities")
...
class GetCapabilities(unittest.TestCase):
    def test_get_capabilities(self):
        ...
        with unittest.mock.patch("autils.process.process.run", return_value=cmd_result):
